 ...
 * would let a disposition field exist without receipt ancestry, widen coverage
 * silently, or flip an organ to MEASURED without a readout receipt. Offline;
 * no network, provider, or inference calls.
 */
